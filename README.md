...
| :--- | :--- | :--- |
| 🚀 [**Ned Studio**](https://github.com/Nkounga42/Ned-studio) | Gestion d'organisation intelligente. | Node.js, MongoDB |
| 🎮 [**Atomic Game**](https://atomicgame.vercel.app/) | Plateforme interactive gaming. | React, Vite |
| 🎵 [**Hache Beat Cloud**](https://hache-beat-cloud.vercel.app/) | Plateforme de streaming musical. | Fullstack JS |
| 🕒 [**WidgetHora**](https://github.com/Nkounga42/PYTHON-PROJECT) | Widget desktop élégant pour Windows. | Python, PyQt5 |
